...
export default function Home() {
	...
	useEffect(() => {
		const getStudents = () => {
			axios
				.get(
					"https://student-management-backend-71ziiz8oo.vercel.app/student/get"
				)
				.then((res) => {
	...
	const deleteUser = (id) => {
		Swal.fire({
			...
			if (result.isConfirmed) {
				axios
					.delete(
						`https://student-management-backend-71ziiz8oo.vercel.app/student/delete/${id}`
					)
					.then((res) => {
	...
	return (
		<div className="text-center mb-4">
			<h5 style={{ textAlign: "center", padding: "3rem" }}>
				Thiruanantpuram Univercity, Students Attendance
			</h5>
			<Link to="/add-student">
				<div className="col-4">
